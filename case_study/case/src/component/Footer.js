    ...
    return (
      <footer>
        <div className="row" style={{ background: "#addccf" }}>
          ...
          <div
            className="col-lg-3"
            style={{ backgroundColor: "#fdfdfe", color: "black" }}
          >
            <h2
              style={{
                color: "#cbbe73",
          ...
          <div className="col-lg-3" style={{ marginTop: 30 }}>
            <a
              href="https://furamavietnam.com/activities/"
            ...
            <br />
            <a
              href="https://furamavietnam.com/furama-resort-danang-rack-rate/"
              style={{ color: "#fdfdfe", fontFamily: '"Al Nile"' }}
            >
              Rack Rate
            </a>
            <br />
            <a
              href="https://furamavietnam.com/lifestyle-blog/"
              style={{ color: "#fdfdfe", fontFamily: '"Al Nile"' }}
            >
              Lifestyle Blog
            </a>
            <br />
            <a
              href="https://furamavietnam.com/work-with-us/"
              style={{ color: "#fdfdfe", fontFamily: '"Al Nile"' }}
            >
              Work with us
            </a>
            <br />
            <a
              href="https://furamavietnam.com/contact/"
              style={{ color: "#fdfdfe", fontFamily: '"Al Nile"' }}
            >
              Contact us
            </a>
